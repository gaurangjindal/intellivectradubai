...
const Page = () => {
    return (
        <div>
            <PageStarter tit1={"Terms"} tit2={" & Condition"} tit1Col={"black"} descColor={"black"} imageSrc={"/images/banners/techpartbanner.png"} desc={""}></PageStarter>
            <div className="px-6 py-2 sm:px-12 sm:py-2">
                <div className="w-full mx-auto bg-white text-black p-8 rounded-lg">
                    ...
                    <p className="mb-4">
                        Unless otherwise stated, Intelli Vectra Technologies and/or its licensors own the intellectual property rights for all material on Intelli Vectra. All intellectual property rights are reserved. You may access this from Intelli Vectra for your own personal use subjected to restrictions set in these terms and conditions.
                    </p>
                    <ul className="list-disc list-inside mb-4">
                        <li>Republish material from Intelli Vectra</li>
                        <li>Sell, rent or sub-license material from Intelli Vectra</li>
                        <li>Reproduce, duplicate or copy material from Intelli Vectra</li>
                        <li>Redistribute content from Intelli Vectra</li>
                    </ul>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Intelli Vectra Technologies does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Intelli Vectra Technologies, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Intelli Vectra Technologies shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                    </p>
                    <p className="mb-4">
                        Intelli Vectra Technologies reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                    </p>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        You hereby grant Intelli Vectra Technologies a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                    </p>
