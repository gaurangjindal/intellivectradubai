            ...
            <div className="px-6 py-2 sm:px-12 sm:py-2">
                <div className="w-full mx-auto bg-white text-black p-8 rounded-lg ">
                    ...
                    <ul className="list-disc list-inside mb-4">
                        ...
                        <li><strong>Website</strong> refers to Intelli Vectra, accessible from <a href="https://www.intellivectra.com/" className="text-blue-500 underline">https://www.intellivectra.com/</a></li>
